...
<link rel="stylesheet" type="text/css" href="required/css/base.css" />

<script type="text/javascript" src="http://code.jquery.com/jquery-1.4.2.min.js"></script>
<script type="text/javascript" src="scripts/mioErrHandling.js"></script>
<script type="text/javascript" src="required/js/fancyPagination.js"></script>
...
$(document).ready(function(){
	...
	mioPagination.page.add(20, 'test3', 'page3', {},{location:'testpages/test3.html',type:'text'},{sequential:true});//this page must be seen in sequence
	...
	mioPagination.page.bindByName('page3', function(){alert('You must view all previous pages first');},'page3alert', 'notSequential');
