package com.mediocredeveloper.cloud2.master2;
...
import com.mediocredeveloper.cloud2.master.CloudMasterEvent;
import com.mediocredeveloper.cloud2.master.CloudMasterEventHandler;
...
public class CloudMaster2Test {
    ...
    public void verifyMasterFailurePickedUp() throws InterruptedException {
        CloudMaster2 node1 = new CloudMaster2(GROUP,"node1", hcast1, new MasterEvtHandler(GROUP,"node1"));
        CloudMaster2 node2 = new CloudMaster2(GROUP,"node2", hcast2, new MasterEvtHandler(GROUP,"node2"));
        CloudMaster2 node3 = new CloudMaster2(GROUP,"node3", hcast3, new MasterEvtHandler(GROUP,"node3"));

        node1.elect();

        CloudMaster2 master = null;
