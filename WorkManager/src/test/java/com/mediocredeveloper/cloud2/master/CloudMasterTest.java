...
public class CloudMasterTest {
    ...
    public void verifySingleElection() throws CloudMessageError {
        CloudRegistry registry1 = new CloudRegistry(hcast1, new NodeEvtHandler(), "group", "node1");
        CloudRegistry registry2 = new CloudRegistry(hcast1,  new NodeEvtHandler(), "group", "node2");
    ...
    public void verifyABunchOfElections() throws InterruptedException {
        ...
        CloudRegistry registry1 = new CloudRegistry(hcast1, new NodeEvtHandler(), "group", "node3");
        CloudRegistry registry2 = new CloudRegistry(hcast1, new NodeEvtHandler(), "group", "node4");
