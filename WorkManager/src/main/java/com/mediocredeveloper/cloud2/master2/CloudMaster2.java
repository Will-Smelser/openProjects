 ...
 */
public class CloudMaster2 {
    private static final Logger LOGGER = LoggerFactory.getLogger(CloudMaster2.class);
    ...
    public CloudMaster2(String group, String name, HazelcastInstance hcast, CloudMasterEventHandler handler){
